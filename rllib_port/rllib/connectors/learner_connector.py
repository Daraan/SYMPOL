...
def _learner_connector_without_numpy(
    obs_space, action_space, *, algo: AlgorithmConfig, debug: bool = False
    ...
    if algo.learner_config_dict.get("no_numpy_to_tensor_connector", True):
        gae_estimator._numpy_to_tensor_connector = _NoTensorConverter()  # pyright: ignore[reportPrivateUsage, reportAttributeAccessIssue]
