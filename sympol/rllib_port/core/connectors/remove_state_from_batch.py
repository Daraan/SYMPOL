...
if TYPE_CHECKING:
    from ray.rllib.core.rl_module.multi_rl_module import MultiRLModule, RLModule
...
class RemoveStateFromBatch(ConnectorV2):
    ...
    def __call__(
        self,
        *,
        rl_module: MultiRLModule | RLModule,
        batch: dict[str, Any],
        **kwargs,
    ):
        for module_id in rl_module.keys():  # pyright: ignore[reportAttributeAccessIssue]
