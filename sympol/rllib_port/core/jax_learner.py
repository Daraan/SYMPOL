...
if TYPE_CHECKING:
    ...
    from sympol.sdt import Critic_SDT
    ...
    def _legacy_update(self, batch: dict[str, Any] | SampleBatch[jax.Array]) -> tuple[Any, Any]:
        ...
        for module_id, module_batch in batch.items():
            ...
            storage2 = batch_to_storage(
                module_batch,  # FIXME: Is here a type problem?  - buts its legacy # pyright: ignore[reportArgumentType]
            ...
            actor_state, critic_state, loss, _policy_loss, _v_loss, _entropy_loss, _approx_kl, key = update_ppo(
                actor_state,
                critic_state,
                storage2,
                key,
