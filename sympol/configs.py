...
from sympol.config_types.params_types import MLPParams, SDTParams, SympolParams

if TYPE_CHECKING:
    from sympol.config_types.params_types import ParamsDictType
...
def get_action_type(env_id: str) -> Literal["discrete", "continuous"]:
    try:
        env = gym.make(env_id)
    ...
    if "continuous" in env_id.lower() or "Pendulum" in env_id or "Walker" in env_id:
        return "continuous"
    return "discrete"
...
def suggest_config_sympol(trial: Trial, env_id="") -> SympolParams:
    params: SympolParams = {
        ...
        "learning_rate_actor_split_idx_array": trial.suggest_float(
            "learning_rate_actor_split_idx_array", 0.0001, 0.1, log=True
        ),
        ...
        "n_estimators": 1,
        "action_type": get_action_type(env_id),
    }
