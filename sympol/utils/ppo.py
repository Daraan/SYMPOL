...
from sympol.utils.get_action_and_value import get_action_and_value2
...
if TYPE_CHECKING:
    ...
    from sympol.utils.utils import ActorTrainState, Storage, StorageNoValues, TrainState
...
def update_ppo(
    ...
    *,
    ...
    def update_epoch(carry: tuple[ActorTrainState, TrainState, chex.PRNGKey], _unused_key):
        ...
        shuffled_storage: StorageNoValues = jax.tree_util.tree_map(convert_data, flatten_storage)
