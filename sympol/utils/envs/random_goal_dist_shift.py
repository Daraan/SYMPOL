...
try:
    from minigrid.core.world_object import Goal  # pyright: ignore[reportMissingImports]
    from minigrid.envs.distshift import DistShiftEnv  # pyright: ignore[reportMissingImports]
except ImportError:
    print("MiniGrid not installed; skipping related environments")

    class RandomGoalDistShiftEnv:
        def __init__(self) -> None:
            raise NotImplementedError("MiniGrid not installed; skipping related environments")
