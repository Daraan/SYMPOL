...
@partial(jax.jit, static_argnames=("action_type", "actor", "critic"))
...
def get_action_and_value2(
    ...
    *,
    ...
    actor: _Actor,
    critic: _Critic,
    actor_state_indices: chex.Array,
    ...
    if action_type == "discrete":
        ...
        result = actor.apply(actor_state_params, x, indices=actor_state_indices)
        action_distribution = distrax.MultivariateNormalDiag(result[0], jnp.exp(result[1]))  # pyright: ignore[reportArgumentType]
